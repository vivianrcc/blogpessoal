...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario>  corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L,"Vivian Carrillo",
				"viviancarrillo@email.com.br", "1232323",""));	
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario (0L,
			"Henrique Queiroz", "henriquequeiroz@email.com,br","1233367", "-"));
	...
	@DisplayName("Atualizar um Usuario")
	 public void deveAtualizarUsuario() {
        ...
        Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Aline herrera", "alinehrrc@root.com", "12345678", "url2");
